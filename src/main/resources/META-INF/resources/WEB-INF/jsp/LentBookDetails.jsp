...
function returnbook(){
	...
	if(document.getElementById("status").value=="Return"){
...
<div>
	<br>
  <h2><center>Lent Book Details</center></h2>
  <%-- <center><button onclick="window.location.href = '/Home/ReturnBorrowedBook' ">Return This Book</button></center> --%>
  <br></br>
</div>

<div class="container">

  <form:form id="addform" action="ReturnBorrowedBook" modelAttribute="lent" method="POST">
  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <select onchange="returnbook()" id="status" value="Borrowed" style="height:40px">
  ...
  <div id="returnblock">
      ...
      <div class="col-75">
        <form:input type="text" path="dateofreturn" class="date-picker" readonly="true"/>
      </div>
    </div>
      ...
      <div class="col-25">
        ...
        <label for="subject">Returned Condition</label>
           ...
           <div class="col-75">
        <form:textarea id="returnedcondition" path="returnedcondition" style="height:40px"></form:textarea>
      </div>
    </div>
